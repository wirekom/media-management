...
return array(
    ...
    'username or email' => 'nama pengguna atau alamat email',
    'password' => 'kata sandi',
    'Remember me next time' => 'Ingat saya lain waktu',
    'Username is incorrect.' => 'nama pengguna tidak benar',
    'Email is incorrect.' => 'Alamat email tidak benar',
    "This user's name already exists." => 'Nama pengguna ini sudah dipakai.',
    "This user's email address already exists." => 'Alamat email ini sudah dipakai.',
    'You registered from {site_name}' => 'Ви зареєструвалися на сайті {site_name}',
    'Please activate you account go to {activation_url}' => 'Silahkan melakukan aktivasi akun anda dengan mengklik link berikut {activation_url}',
    'You account is not activated.' => 'Akun anda tidak aktif',
    'You account is blocked.' => 'Akun anda diblokir',
    'Password is incorrect.' => 'Kata sandi tidak benar',
    'E-mail' => 'E-Mail',
    'Verification Code' => 'Kode Verifikasi',
    'Retype Password' => 'Ketik ulang kata sandi',
    'Retype Password is incorrect.' => 'Ketik ulang kata sandi tidak benar',
