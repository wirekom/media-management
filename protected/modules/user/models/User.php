...
class User extends CActiveRecord {
    ...
    public function rules() {
        ...
        return array(
            ...
            array('id, username, password, email, activkey, lastvisit, superuser, status, created, updated', 'safe', 'on' => 'search')
        );
    }
    ...
    public function scopes() {
        return array(
            ...
            'notsafe' => array(
                'select' => 'id, username, password, email, activkey, lastvisit, superuser, status',
            ),
        );
    }
